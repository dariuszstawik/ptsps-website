...
export default function TestimonialCard({ name, title, img, children }) {
  return (
    // <div className="h-[520px] p-6 flex flex-col justify-between bg-slate-100 shadow rounded mx-4">
    //   <div>
    // <svg
    //   className="mb-6 text-primaryOrange h-8"
    //   viewBox="0 0 32 28"
    //   fill="none"
    ...
    //   />
    // </svg>
    //     <p className="text-gray-500 leading-loose mb-4">{children}</p>
    //   </div>
    //   <div>
    //     <h5 className="font-bold font-heading">{name}</h5>
